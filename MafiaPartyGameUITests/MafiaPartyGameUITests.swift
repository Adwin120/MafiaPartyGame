//
//  MafiaPartyGameUITests.swift
//  MafiaPartyGameUITests
//
...
final class MafiaPartyGameUITests: XCTestCase {
    ...
    @MainActor
    func testCantAddPlayerWithNoCharacter() throws {
        // UI tests must launch the application that they test.
        let app = XCUIApplication()
        app.launch()
    ...
    @MainActor
    func testCantStartGameWithIncorrectSetup() throws {
        // UI tests must launch the application that they test.
        let app = XCUIApplication()
        app.launch()
    ...
    @MainActor
    func testTurnChangingPerformance() throws {
        if #available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 7.0, *) {
            // This measures how long it takes to launch your application.
            measure(metrics: [XCTApplicationLaunchMetric()]) {
                XCUIApplication().launch()
